...
{
    public partial class Frmcustrecived : Form
    {
        company DC;
        IUnitofwork _IUW;
        List<Tailopratordto> _LTO;
        public Frmcustrecived()
        {
            InitializeComponent();
            Loading();
        }
        public void Loading()
        {
            ...
            _LTO = _IUW.tailorheaders.GetQueryable()
                              ...
                              .Select(tailorheader => new Tailopratordto // <= استخدم الكلاس هنا
                              {
                                  ...
                                  Clothesrecived = tailorheader.Clothesrecived == null ? 0 : tailorheader.Clothesrecived.Value, // تأكد من التعامل مع القيمة القابلة لـ Null
        ...
        private void Btnsave_Click(object sender, EventArgs e)
        {
            foreach (DataGridViewRow row in dgvoprator.Rows)
            {
                ...
                var clothesCell = row.Cells["Clothesrecived"]?.Value;
            ...
            if (e.KeyChar == (char)Keys.Enter)
            {
                ...
                if (!string.IsNullOrEmpty(textBox15.Text.Trim()))
                {
                    ...
                    if (foundItem != null)
                    {
                        ...
                        dgvoprator.Rows[newRowIndex].Cells["Clothesrecived"].Value = foundItem.Clothesrecived;
