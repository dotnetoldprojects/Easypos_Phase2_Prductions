        ...
        private string ConvertNumberToAlpha(string Number)
        {
            if (Number.Contains('.'))
            {
                ...
                else
                {
                    ...
                    {
                        case 1: return convertOneDigits(Number.ToString()) + " ريال سعودي " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 2: return convertTwoDigits(Number.ToString()) + " ريال سعودي " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 3: return convertThreeDigits(Number.ToString()) + " ريال سعودي " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 4: return convertFourDigits(Number.ToString()) + " ريال سعودي " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 5: return convertFiveDigits(Number.ToString()) + " ريال سعودي " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 6: return convertSixDigits(Number.ToString()) + " ريال سعودي " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        default: return "";
                    }
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    {
                        case 1: return convertOneDigits(Number.ToString()) + " ريال سعودي ";
                        case 2: return convertTwoDigits(Number.ToString()) + " ريال سعودي ";
                        case 3: return convertThreeDigits(Number.ToString()) + " ريال سعودي ";
                        case 4: return convertFourDigits(Number.ToString()) + " ريال سعودي ";
                        case 5: return convertFiveDigits(Number.ToString()) + " ريال سعودي ";
                        case 6: return convertSixDigits(Number.ToString()) + " ريال سعودي ";
                        default: return "";
                    }
