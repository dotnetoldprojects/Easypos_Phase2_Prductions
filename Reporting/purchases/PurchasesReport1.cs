...
namespace Reporting.purchases {
    ...
    public class PurchasesReport : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Reporting.purchases.PurchasesReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPurchasesReport : Component, ICachedReport {
        
        public CachedPurchasesReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PurchasesReport rpt = new PurchasesReport();
            rpt.Site = this.Site;
            return rpt;
        }
