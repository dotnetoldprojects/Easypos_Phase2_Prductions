...
namespace Reporting.sales.Normal.Big {
    ...
    public class Bigsalesbill : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Reporting.sales.Normal.Big.Bigsalesbill.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBigsalesbill : Component, ICachedReport {
        
        public CachedBigsalesbill() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Bigsalesbill rpt = new Bigsalesbill();
            rpt.Site = this.Site;
            return rpt;
        }
